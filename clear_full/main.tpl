...
<div class="container">
    ...
    <div class="row">
        ...
        {% endif %}
        {% if module.news_top_view %}
            <div class="col-md-4">{{ module.news_top_view }}</div>
        {% endif %}
        {% if module.news_new %}
            <div class="col-md-4">{{ module.news_new }}</div>
        {% endif %}
        {% if module.lastcomments %}
            <div class="col-md-4">{{ module.lastcomments }}</div>
        {% endif %}
        {% if module.tag_cloud %}
            <div class="col-md-4">{{ module.tag_cloud }}</div>
        {% endif %}
    </div>
</div>
